(function($) {
	...
	if($('.main-header li.dropdown ul').length){
		$('.main-header li.dropdown').append('<div class="dropdown-btn"><span class="fa fa-angle-right"></span></div>');
	...
	if($('.mobile-menu').length){
		...
		$('.mobile-menu .menu-box .menu-outer .navigation').append(mobileMenuContent);
	...
	if ($('.room-detail .image-carousel').length && $('.room-detail .thumbs-carousel').length) {

		var $sync1 = $(".room-detail .image-carousel"),
			$sync2 = $(".room-detail .thumbs-carousel"),
			flag = false,
			duration = 500;
